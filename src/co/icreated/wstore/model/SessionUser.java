...
public class SessionUser implements Principal {
  ...
  public SessionUser(int AD_User_ID, String value, String name, String email, String password,
      String salt, int C_BPartner_ID, int C_BP_Group_ID, int M_PriceList_ID, int C_PaymentTerm_ID,
