...
public class WebStoreInternalServerException extends WebApplicationException {
   ...
   */
  public WebStoreInternalServerException() {
   ...
   */
  public WebStoreInternalServerException(String message) {
