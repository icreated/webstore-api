...
public class WebStoreUnauthorizedException extends WebApplicationException {


  private static final long serialVersionUID = 3879914897309582139L;


  public WebStoreUnauthorizedException() {
    super(Response.status(Response.Status.UNAUTHORIZED).build());
  }

  public WebStoreUnauthorizedException(String message) {
