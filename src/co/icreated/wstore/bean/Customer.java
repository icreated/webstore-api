...
public class Customer {
  ...
  public Customer(MBPartner bpartner, MUser user, String bpartnerName, String firstName,
      String lastName, String email, String phone, String phone2, String fax, String description,
      boolean isDefault) {
    super();
