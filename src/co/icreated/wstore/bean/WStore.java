...
public class WStore {
  ...
  public WStore(int W_Store_ID, int AD_Client_ID, int AD_Org_ID, int SalesRep_ID,
      int M_PriceList_ID, int M_Warehouse_ID, String name, String description, String help,
      String webParam1, String webParam2, String webParam3, String webParam4, String webParam5,
      String webParam6, String stylesheet, int C_PaymentTerm_ID, String url) {
    super();
