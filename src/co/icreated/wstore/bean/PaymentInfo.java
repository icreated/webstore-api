...
public class PaymentInfo {
  ...
  public PaymentInfo(BigDecimal amount, int C_Currency_ID, String tenderType, String transactionId,
      String creditCardType, String creditCardNumber, int creditCardExpMM, int creditCardExpYY) {
    super();
    this.amount = amount;
  ...
  public PaymentInfo(BigDecimal amount, int C_Currency_ID, String mpaymentType,
